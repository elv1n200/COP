...
object NVGRenderer {
    ...
    val defaultFont = Font("Default", mc.resourceManager.getResource(ResourceLocation.parse("cop:font.ttf")).get().open())
    val customFont = Font("Custom", File("config/cop/font.ttf").takeIf { it.exists() }?.inputStream() ?: mc.resourceManager.getResource(ResourceLocation.parse("cop:font.ttf")).get().open())
...
//
    ...
    fun String.image() = createImage("/assets/cop/ui/images/$this")
