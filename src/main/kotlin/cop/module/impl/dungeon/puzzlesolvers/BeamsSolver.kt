package cop.module.impl.dungeon.puzzlesolvers
...
import cop.utils.skyblock.ItemUtils.isShortbow
import cop.utils.skyblock.player.PlayerUtils.at
...
object BeamsSolver {
    ...
    private val isr = this::class.java.getResourceAsStream("/assets/cop/puzzles/creeperBeamsSolutions.json")?.let { InputStreamReader(it, StandardCharsets.UTF_8) }
