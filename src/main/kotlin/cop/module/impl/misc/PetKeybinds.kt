...
import cop.utils.ChatUtils.button
...
import cop.utils.skyblock.ItemUtils.petHeldItem
...
//            modMessage("&aRemoved &r$name&a pet from the pet list!")
    ...
    fun List<Pet>.toClickable(source: String): MutableComponent {
        ...
        this.forEachIndexed { i, (uuid, name, heldItem) ->
            ...
            result.append(button(symbol, "/cop petkeybinds $command $source $uuid $name", hoverText))
