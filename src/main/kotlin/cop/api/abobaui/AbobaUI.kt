...
import cop.api.abobaui.events.EventManager
import cop.api.abobaui.events.Lifetime
import cop.api.abobaui.operations.Operation
...
class AbobaUI(val title: String) {
    ...
    inline var clipboard: String?
        ...
        set(value) {
            // KeyboardHandler.setClipboard tightened to non-null in 1.21.11; an
            // empty string clears the clipboard the same way `null` did before.
            mc.keyboardHandler.clipboard = value.orEmpty()
        }
